...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\large{Kenneth Gao}} $|$ {\href{mailto:hello@kenf.dev}{hello@kenf.dev}} $|$ {\href{www.kenf.dev}{\underline{www.kenf.dev}}} & \textbf{Visa:} H-1B1 eligible \\
...
\section{EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Created tools to speed up incident response, among other things}
    \resumeItemListEnd
