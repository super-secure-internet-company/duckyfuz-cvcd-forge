...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\large{Kenneth Gao}} $|$ {\href{mailto:hi@kenf.dev}{hi@kenf.dev}} $|$ {\href{www.kenf.dev}{\underline{www.kenf.dev}}} & \textbf{Location:} Singapore \\
...
\section{EDUCATION}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{National University of Singapore}}{Expected Grad: Nov 2026}
...
\section{EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{Software Engineering Intern @ \textit{Jump Trading LLC}}}{May 2026 - Aug 2026}
    % \resumeDescription{One of the proprietary trading firms of all time}
    \resumeItemListStart
      \resumeItem{Created tools to speed up incident response, among other fascinating things}
    \resumeItemListEnd
...
\section{PROJECTS}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{Lightweight Bounds Checking for C/C++} $|$ \href{https://github.com/duckyfuz/llvm-flexfat/tree/flexfat/main}{\underline{LLVM instrumentation}}}{Jan 2026 - Present}
      \resumeItemListStart
        \resumeItem{Developed LLVM23 instrumentation and runtime support for bounds checking on AArch64 and x86, based on Duck \& Yap's \href{https://www.comp.nus.edu.sg/~gregory/papers/cc16lowfatptrs.pdf}{\underline{low-fat pointer methodology}}}
        \resumeItem{Leveraged AArch64's Top Byte Ignore (TBI) to implement use-after-free detection}
        \resumeItem{Measured 11\% lower runtime and 10\% lower peak RSS than HWASan on AArch64}
    \resumeItemListEnd
